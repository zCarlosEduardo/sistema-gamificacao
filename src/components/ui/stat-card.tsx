...
export function StatCard({ label, valor, icon: Icon }: StatCardProps) {
  return (
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex items-center gap-3 hover:shadow-sm transition-shadow">
      ...
      <div>
        <p className="text-2xl font-bold text-zinc-900 dark:text-white leading-none">{valor}</p>
